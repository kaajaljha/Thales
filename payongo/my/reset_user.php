...
<html lang="en">
  ...
  <link rel="fluid-icon" href="https://my.softstack-research.co/icon.png" title="Softstack Research">
  <meta name="selected-link" value="https://my.softstack-research.co/reset" data-pjax-transient>
...
<form action="reset_user.php" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="" />      <input type="hidden" name="ga_id" class="js-octo-ga-id-input">
...
<?php include('messages.php'); ?>
        ...
        <input type="text" name="email" id="login_field" class="form-control input-block" tabindex="1" autocapitalize="off" autocorrect="off" autofocus="autofocus" />
        
 <input type="submit" name="reset-password" value="Submit" tabindex="3" class="btn btn-dark btn-block" data-disable-with="Submitting..." />
      </div>
</form>
</div>
